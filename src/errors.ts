export type ErrorCode =
  ...
  | 'RESULT_READ_FAILED' | 'RESULT_SERIALIZATION_FAILED' | 'INVOCATION_CANCELLED' | 'NOT_FOUND' | 'SERVICE_STOPPING' | 'INTERNAL_ERROR';
